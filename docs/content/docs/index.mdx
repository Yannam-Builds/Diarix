---
title: "Diarix Documentation"
description: "Diarix is the open-source, local-first AI voice studio — a free alternative to ElevenLabs and WisprFlow, running entirely on your machine."
---

Diarix is the **open-source, local-first AI voice studio** — a free
...
> **Fork notice:** Diarix is an independent fork built from
> [Voicebox](https://github.com/jamiepine/voicebox) by Jamie Pine and its
> contributors. Voicebox remains the upstream project. Compatibility names such
> as `voicebox.*` MCP tools and `.voicebox.zip` archives are retained so existing
> workflows continue to work.

![Diarix App Screenshot](/images/app-screenshot-1.webp)
...
- **Agents speak back** — any MCP-aware agent can call Diarix to speak in one of your cloned voices
...
- [Installation](/overview/installation) — download and install Diarix
