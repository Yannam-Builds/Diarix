...
description: "Common issues and solutions for Diarix"
---

This guide covers common issues you might encounter when using or developing Diarix, along with solutions.
...
xattr -cr /Applications/Diarix.app
```
...
<AccordionGroup>
  ...
  <Accordion title="Install flash-attn on Windows (community wheels)">
    ...
    Alternatively, run Diarix's backend inside WSL2 and use the standard Linux wheels.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Check GPU Selection">
    If you have multiple GPUs, ensure Diarix is using the right one.
