...
how Diarix strips Whisper loop hallucinations *before* the LLM sees the
...
The original audio is kept alongside the transcript in your Diarix data
...
[Remote Mode](/overview/remote-mode) for running Diarix as a server the rest
