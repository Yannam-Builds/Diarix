---
title: "Installation"
description: "Download and install Diarix on macOS, Windows, or Linux"
---

## Diarix Builds

Diarix does not yet publish signed installers. Build this repository locally while the Diarix
release channel is being prepared.

<Callout type="warn">
  The downloads below are official upstream Voicebox builds. They do not include Diarix's
  transcription engines or branding and must not be installed as Diarix updates.
</Callout>

## Upstream Voicebox Downloads
...
When you launch Diarix for the first time:
