---
title: "Quick Start"
description: "Get started with Diarix in 5 minutes"
---
...
Make sure you have [installed Diarix](/overview/installation) and launched the app.

## Step 1: Create a Voice Profile

Voice profiles are the foundation of Diarix. Each profile contains voice samples that the AI uses to clone the voice.
...
<Steps>
  ...
  <Step title="Enter Text">
    ...
    ```
    Hello! This is my first voice generation with Diarix.
    ```
...
<Cards>
  ...
  <Card title="API Integration" href="/api-reference">
    Integrate Diarix into your own applications
  </Card>
